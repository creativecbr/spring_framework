...
public class CommandLine implements CommandLineRunner {
    ...
    private String login, name, surname, email, year, month, day, password, description, categoryName, title, answer, id;
    ...
    private void printUserAds() throws IOException {
        ...
        userService.find(login).ifPresentOrElse(
                original ->{
                    userService.findAllUsersAds(login).forEach(System.out::println);
